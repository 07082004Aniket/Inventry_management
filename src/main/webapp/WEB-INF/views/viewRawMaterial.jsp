...
<%
		...
		{%>
			...
			<td><a href="deleteRaw?id=<%=c.getId()%>">Delete</a></td>
			<td><a href="updateRaw?id=<%=c.getId()%>">Update</a></td>
			<td><a href="addissueraw?id=<%=c.getId()%>">issue</a></td>
			</tr>
			
		<% }
		%>
</table>
<button><a href="addraw">Add Item</a></button>
