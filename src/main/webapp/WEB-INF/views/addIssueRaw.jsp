...
<body>
   ...
   <nav>
    ...
    <div class="content">
        <article>
		        <%RawMaterial raw= (RawMaterial) request.getAttribute("issueRawMaterialList"); %>
<fieldset>
		<legend>Issue Raw  Material </legend>
		<form action="addissuerawdb" method="post">
		<h3>Add Processed  here</h3>
		<p>Enter the id</p>
		<input type="text" name="id" placeholder=" ">
		<p>Enter the rawId</p>
		<input type="text" name="rawId" value=<%=raw.getId() %>>
		<p>Enter the rawName</p>
		<input type="text" name="rawName" value=<%=raw.getName() %>>
