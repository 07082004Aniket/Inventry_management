...
<%List<ProcessedMaterial> processedMaterial= (List<ProcessedMaterial>) request.getAttribute("processedMaterialList"); %>
<table>
...
<%
		for(ProcessedMaterial c: processedMaterial)
		{%>
			<tr>
			<td><%=c.getId() %></td>
			<td><%=c.getName() %></td>
			...
			<td><a href="deleteProcessed?id=<%=c.getId()%>">Delete</a>
			<td><a href="updateProcessed?id=<%=c.getId()%>">Update</a>
			<td><a href="addissuepro?id=<%=c.getId()%>">issue</a></td>
			</tr>
			
		<% }
		%>
</table>
<button><a href="addprocessed">Add Item</a></button>
		<a href="view">go to home page</a>
