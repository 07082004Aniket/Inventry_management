...
<body>
   ...
   <nav>
    ...
    <div class="content">
        <article>
		          <%RawMaterial raw= (RawMaterial) request.getAttribute("rawMaterialList"); %>

<fieldset>
		<legend>Add Raw Material </legend>
		<form action="updateRawdb" method="post">
		<h3>Add Raw  here</h3>
		<p>Enter the id</p>
		<input type="text" name="id"  value=<%=raw.getId() %>>
		<p>Enter the Name</p>
		<input type="text" name="name" value=<%=raw.getName() %>>
		<p>Enter the quantity</p>
		<input type="text" name="quantity" value=<%=raw.getQuantity() %>>
		<p>Enter the unit</p>
		<input type="text" name="unit" value=<%=raw.getUnit() %> >
		<p>Enter the costPerUnit</p>
		<input type="text" name="costPerUnit" value=<%=raw.getCostPerUnit() %>>
		<p></p>
